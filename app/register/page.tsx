...
export default function RegisterForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Supabase u již existujícího emailu nevrací error (ochrana proti
    // emailové enumeraci), ale vrátí usera s prázdným polem identities.
      ...
      <div className="relative bg-white dark:bg-gray-800/50 mx-auto w-full max-w-md rounded-2xl ring shadow-xl ring-gray-900/5 p-6">
        ...
        <div className="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="email" className="block text-sm/6 font-bold dark:text-slate-300 text-stone-700">
                Email
              </label>
              <div className="mt-2">
                <input
            ...
            <div>
              <label htmlFor="password" className="block text-sm/6 font-bold dark:text-slate-300 text-stone-700">
                Heslo
              </label>
              <div className="mt-2">
                <input
