...
export default function CompleteProfileForm() {
  ...
  required
  minLength={3}
  className="w-full rounded-md border px-3 py-2 dark:bg-slate-900 dark:border-slate-800 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-emerald-500"
/>
